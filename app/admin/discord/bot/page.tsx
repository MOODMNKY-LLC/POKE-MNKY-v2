...
import { Loader2, Bot, CheckCircle2, XCircle, Play, Square, RefreshCw, Info } from "lucide-react"
...
export default function DiscordBotPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2">Discord Bot Management</h1>
        <p className="text-muted-foreground">
          Manage the Discord bot that automatically syncs roles and assigns coaches to teams
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                When an admin assigns the <Badge variant="outline">Coach</Badge> role to a user in Discord, the bot
                automatically detects this change.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                The bot syncs the Discord role to the app, updating the user's profile role to{" "}
          ...
          <Alert>
            <Info className="h-4 w-4" />
            <AlertTitle>Important: Role Name</AlertTitle>
            <AlertDescription>
              The Discord role must be named exactly <strong>"Coach"</strong> (capital C, lowercase oach) for the
              automatic sync to work. This is configured in <code className="bg-muted px-1 rounded">lib/discord-role-sync.ts</code>.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Current Role Mappings</CardTitle>
          <CardDescription>Discord roles mapped to app roles</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div className="flex items-center gap-3">
                <Badge variant="outline">League Admin</Badge>
                <span className="text-muted-foreground">→</span>
                <Badge variant="destructive">admin</Badge>
              </div>
            </div>
          ...
          <p className="text-sm text-muted-foreground mt-4">
            To change these mappings, edit <code className="bg-muted px-1 rounded">lib/discord-role-sync.ts</code>
          </p>
        </CardContent>
      </Card>
