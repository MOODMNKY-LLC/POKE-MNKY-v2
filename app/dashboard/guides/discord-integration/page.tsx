    ...
    <>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 max-w-3xl">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Discord Integration Guide</h1>
            <p className="text-muted-foreground text-sm">
              Webhooks, bot commands, channel mapping, and integration status for the league Discord server
            </p>
          </div>
        </div>
        <Card>
          <CardHeader>
            ...
            <CardDescription className="sr-only">
              Full guide for Discord integration: webhooks, bot commands, and server map
            </CardDescription>
          </CardHeader>
