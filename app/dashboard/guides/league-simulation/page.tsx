...
function getGuideContent(): string {
  try {
    ...
    return "# League Simulation & Testing Guide\n\nGuide content could not be loaded. See **Settings → Guides** for links and **docs/LEAGUE-SIMULATION-AND-TESTING-GUIDE.md** in the project."
  }
}

export default function LeagueSimulationGuidePage() {
    ...
    <>
      <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbPage>League Simulation</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </header>
      <div className="flex flex-1 flex-col gap-4 p-4 max-w-3xl">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">League Simulation & Testing Guide</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="sr-only">
              Full guide for league simulation and testing
            </CardDescription>
          </CardHeader>
