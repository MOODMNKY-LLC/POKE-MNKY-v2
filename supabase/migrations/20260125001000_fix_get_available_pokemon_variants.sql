-- Robust version: choose draft_pool variant (is_available vs status) at runtime
...
COMMENT ON FUNCTION public.get_available_pokemon_for_free_agency IS 'Robust: detects draft_pool variant (is_available vs status) and compares by pokemon_name to avoid cross-type mismatches';
